...
// Validate if menuItem data provided are correct
...
// Validate if menuItemId exist, and add to req.menuItem if so.
...
// GET all menu-items from menuId
...
// POST new menuItem associate with menuId
